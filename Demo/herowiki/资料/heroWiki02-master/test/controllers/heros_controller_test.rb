...
class HerosControllerTest < ActionController::TestCase
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post :create, hero: { birthday: @hero.birthday, constellation: @hero.constellation, country: @hero.country, description: @hero.description, name: @hero.name, school: @hero.school }
    end
  ...
  test "should update hero" do
    patch :update, id: @hero, hero: { birthday: @hero.birthday, constellation: @hero.constellation, country: @hero.country, description: @hero.description, name: @hero.name, school: @hero.school }
    assert_redirected_to hero_path(assigns(:hero))
  end

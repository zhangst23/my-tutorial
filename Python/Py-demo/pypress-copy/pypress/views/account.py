...
from flask import Module,Response,request,flash,jsonify,g,current_app,abort,redirect,url_for,session
...
def signup():
    ...
    if form.validata_on_submit():
        ...
        from.code.errors.append(_("Code is not allowed"))

...
from pypress.helopers import render_template
...
def configure_identity(app):
    ...
    @identity_loaded.connect_vie(app)
...
def configure_context_processors(app):
    ...
    def lastest_comments():
        ...
        if latest_comments is None:
            latest_comments = Comment.query.order.order_by(Comment.created_date.desc()) \
                                                 .limit(5).all()
...
def configure_modules(app,mosules):

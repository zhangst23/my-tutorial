			...
			<View style={{}}>		
				<View style={[styles.height160, styles.row]}>
					<View style={[styles.height160, styles.part_1_left]}>
						...
						<Image style={[styles.yue]} source={{uri:'http://p0.meituan.net/sss.png'}}></Image>
					</View>
					...
					<View style={[styles.height160, styles.part_1_right,]}>
						<View style={[styles.row, {flex:1}]}>
							...
							<View style={[{flex:1}, {marginTop:-13}]}>
								<Image style={[styles.hanbao]} source={{uri:'#'}}></Image>
							</View>
						</View>
						<View style={[{flex:1, flexDirection: 'row', borderTopWidth:0.5, borderColor: '#DDD8CE'}]}>
							<View style={{flex:1, borderRightWidth:1, borderColor:'#DDD8CE',}}>
								...
								<Image style={{height:25, width:25, alignSelf: 'center'}} source={{uri:'#'}}></Image>
							</View>
							<View style={{flex:1,}}>
				...
				<View>
					<View style={{borderBottomWidth:1, borderTopWidth:1, borderColor:'#DDD8CE', marginTop:40, height:65, flexDirection:'row', paddingTop:10}}>
						<View style={[{flex:1}]}>
							<Text style={{fontSize:17, color:'#FF7F60', fontWidth:'900', marginLeft:7}}>一元吃大餐</Text>
							<Text style={{marginLeft:7, fontSize:12, marginTop:3}}>新用户专享</Text>
						</View>
						<View style={{flex:1}}>
							<Image style={{height:50, width:120}} source={{uri:'#'}}></Image>
						</View>
					</View>
				</View>
				...
				<View>
					<View style={{flexDirection:'row',}}>
						...
						<View style={{flex:1}}>
							<Image style={{width:60, height:55}} source={{uri:'#'}}></Image>
						</View>
					</View>
				...
				<View style={{flexDirection: 'row',}}>
					<View style={[style.row, {borderColor:'#', borderRightWidth:1, marginLeft:1},]}>
						<View style={{flex:1}}> 

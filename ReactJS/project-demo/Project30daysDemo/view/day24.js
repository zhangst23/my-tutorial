...
import Icon from 'react-native-vextor-icons/Ionicons';
			...
			<View>
				...
				<View style={styles.nav}>
					...
					<View style={styles.iconContainer}>
						<Icon name="ios-search-string" color="#fff" size={25}/>
						<Icon name="android-more-vertical" color="#fff" size={25}/>
					</View>
				</View>
				<ScrollableTabView
					onChangeTab={(obj) => tihs._updateTitle(obj)}

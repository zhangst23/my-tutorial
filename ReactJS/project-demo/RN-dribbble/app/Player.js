...
var ShotDetail = require("./ShotDetails");
				...
				<TouchableOpacity onPress={this.openModal}>
					<View style={styles.headerContent}>
						<View style={styles.innerHeaderContent}>
							...
							<Text style={styles.playUsername}>{this.props.player.username}</Text>
							<Text style={styles.playName}>{this.props.player.name}</Text>

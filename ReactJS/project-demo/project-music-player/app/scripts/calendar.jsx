...
class Calendar extends React.Component {
	...
	render(){
		...
		dayLiNode = dayArr.map((day, index) => {
			...
			return <li className={liStyle} key={index} onClick={this.selectDays(dya).bind(this)}>{day}</li>;
		});
		...
		return (
			<div className="calendar">
				<div className="calendar-header">
					...
					<p className="triangle-left" onClick={this.clickTriangleLeft}>{this.clickTriangleLeft}</p>
					<p className="triangle-right" onClick={this.clickTriangleRight}></p>
				</div>

				<div className="div weekday">
					<ul>
						<li>日</li>
						<li>一</li>
						<li>二</li>
			...
			<div className="calendarInput"><input type="text" name="calendar" readOnly="readOnly" value={formatDate}></div>

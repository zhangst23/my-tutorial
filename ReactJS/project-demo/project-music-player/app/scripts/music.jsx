...
class MusicButton extends React.Component{
	constructor(props){
		...
		//记住你所有的component的手动绑定的事件都要在willUnmout干掉
		...
		render(){
			...
			return  (
				<article className="musicContent">
					<audio src="{this.state.song}" ref="audio"></audio>
		...
		render(){
			<article className="music">
				<nav className="linkToDetail">
					<Link to="Summary">
						<div class="detailPeople guidePerson">总结~</div>
					</Link>
				</nav>
				...
				<article>
					<footer class="footer">powered by youzi.</footer>
				</article>
